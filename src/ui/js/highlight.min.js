...
!(function(e) {
  ...
  function o(e, a, n) {
    ...
    for (var l = 0, u = '', d = []; e.length || a.length; ) {
      ...
      if (((u += t(n.substring(l, b[0].offset))), (l = b[0].offset), b === e)) {
        d.reverse().forEach(c)
        do o(b.splice(0, 1)[0]), (b = i())
        while (b === e && b.length && b[0].offset === l)
        d.reverse().forEach(s)
      } else
        b[0].event === 'start' ? d.push(b[0].node) : d.pop(),
          o(b.splice(0, 1)[0])
    }
  ...
  function d(e, r, n, i) {
    ...
    function m() {
      ...
      for (n = '', r = 0, N.lR.lastIndex = 0, a = N.lR.exec(E); a; )
        (n += t(E.substring(r, a.index))),
          (e = l(N, a)),
          e ? ((M += e[1]), (n += p(e[0], t(a[0])))) : (n += t(a[0])),
          (r = N.lR.lastIndex),
          (a = N.lR.exec(E))
      return n + t(E.substr(r))
    }
    function f() {
      var e = typeof N.sL === 'string'
    ...
    function h(e, t) {
      if (((E += e), t == null)) return g(), 0
      var r = s(t, N)
      if (r)
        return (
          r.skip ? (E += t) : (r.eB && (E += t), g(), r.rB || r.eB || (E = t)),
          _(r, t),
          r.rB ? 0 : t.length
        )
      var a = c(N, t)
      if (a) {
        ...
        do N.cN && (C += R), N.skip || (M += N.r), (N = N.parent)
        while (N !== a.parent)
    ...
    try {
      ...
      if (A.message && A.message.indexOf('Illegal') !== -1)
  ...
  return (
    ...
    e.registerLanguage('perl', function(e) {
      ...
      return (
        (r.c = s), (a.c = s), {aliases: ['pl', 'pm'], l: /[\w\.]+/, k: t, c: s}
      )
    }),
